...
ActiveRecord::Schema[8.0].define(version: 2026_01_20_113134) do
  ...
  create_table "comment_ratings", force: :cascade do |t|
    ...
    t.index ["comment_id", "user_id"], name: "index_comment_ratings_on_comment_id_and_user_id", unique: true
